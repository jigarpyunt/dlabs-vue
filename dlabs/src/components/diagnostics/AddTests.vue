  ...
  <div class="row" v-if="activePills.first">
      <div class="col-lg-7 form-data">
          <div class="form-row">
              <div class="col-lg-4 form-group">
                  ...
                  <input type="text" placeholder="Specify test name" class="form-control">
              </div>
              <div class="col-lg-4 form-group">
                  <label for="">Test Unit</label>
                  <input type="text" placeholder="Specify test unit mg/dl" class="form-control">
              </div>
              <div class="col-lg-4 form-group">
                  <label for="">Test Range</label>
                  <input type="text" placeholder="Specify test range  12.0 - 30.9" class="form-control">
              </div>
          </div>
          <div class="form-row">
              <div class="col-lg-4 form-group">
                  <label for="">Test Price</label>
                  <input type="text" placeholder="Specify test price 1500" class="form-control">
              </div>
              <div class="col-lg-4 form-group">
                  <label for="">Test Code Prefix</label>
                  <input type="text" placeholder="Specify test prefix LIP" class="form-control">
              </div>
              <div class="col-lg-4 form-group">
   ...
   <div class="row" v-if="activePills.second">
      <div class="col-lg-7 form-data">
          ...
          <div class="form-row">
              <div class="col-lg-12 form-buttons">
                  <button class="previous" @click="ChangePill('first')">Previous</button>
                  <button class="save">Save</button>
              </div>
          </div>
      </div>    
...
.form-data {
    ...
    input[type='text'] {
        ...
        border: none;
        border-radius: 0px;
        border-bottom: 2px solid rgba(32,166,237,0.50);
        @include apply-font($ptsans, $regular, 14px, #000);
        letter-spacing: 1.5px;
    ...
    textarea {
        ...
        overflow-y: scroll;
        text-indent: 10px;
        border: 2px solid rgba(32,166,237,0.50);
        padding-top: 20px;
        resize: none;
